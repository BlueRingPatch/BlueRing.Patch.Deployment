...
project_name = "BlueRing";  -- Put your project name here to replace all uses of World of Warcraft in strings with your projects' name.
...
Thank you for helping us to improve BlueRing!]]
	...
	FEEDBACKUI_WELCOME = "\nThank you for offering feedback on BlueRing. Each and every submission we receive plays an important role in determining the quality of the expansion.\n\nPlease fill out this short questionnaire so that we may efficiently process the huge amount of feedback we receive.\n\nThank You,\nThe " .. project_name .. " Expansion Team";
