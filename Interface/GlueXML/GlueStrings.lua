...
ACCOUNT_NAME = "BlueRing Account Name";
...
CHAR_LOGIN_LOCKED_BY_MOBILE_AH = "Your client is out of date. Please use the BlueRing Launcher to update your game, patches, and to install required dependencies. If this error persists contact BlueRing support.";
...
REALM_HELP_FRAME_URL = "<a href=\"https://discord.bluering.gg/\">BlueRing Discord</a>";
...
TECH_SUPPORT_URL = "https://discord.bluering.gg";
TEMP_ARMOR = "- Cloth\n- Leather\n- Mail";
